...
InputFile<-"test_data_habitat.csv"
Output<-"~/output/"
...
BBT_coordinates = "BBT.geojson"
BBT_layer <- ""
SubzoneShapeName = "grid.geojson"
...
grid_polygons_sf_region <- st_sf(grid_id = seq_along(GRD_region[Polygon_coordinated_4326$geom]), 
                          geometry = GRD_region[Polygon_coordinated_4326$geom], crs = 4326)
...
grid_polygons_sf_nation <- st_sf(grid_id = seq_along(GRD_nation[Polygon_coordinated_4326$geom]), 
                          geometry = GRD_nation[Polygon_coordinated_4326$geom], crs = 4326)
# Get Spatialpoint from dataset
# Done in point 6: EcoComp1.2coord

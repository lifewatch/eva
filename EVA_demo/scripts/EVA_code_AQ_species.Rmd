...
InputFile<-"../data/test_data_sp.csv"
Output<-"../output_sp/"
OutputFileName<-"EVA_EC_sp"
...
# Hardcoded  rare species list
RareSpecList <- data.frame(
  ScientificName = c("Sp7"),  # species names
  grid_id = numeric(64)            # number of grid cells (count)
)

# Hardcoded common species list 
CommonSpecList <- data.frame(
  ScientificName = c("Sp1", "Sp2", "Sp3", "Sp4", "Sp5", "Sp6", "Sp8"),  # example species
  grid_id = c(64, 64, 64, 64, 64, 64,64)                                   # example grid cell counts
)

...
**Density**
If the data used comes from modelling data, it is assumed that density represents the percentage of coverage of a specific feature over a subzone. This percentage must then be divided by 100 so that the density ranges from 0 to 1.
...
**AQi**: identifies the ith Assessment Question, which in the equation is assigned a value of 1 if it
has been answered or 0 if not answered. 
